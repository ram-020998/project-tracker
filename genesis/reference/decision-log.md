...
## ADR-056 — The Genesis Feature Workspace (parallel, plug-in stages) (Phase 28) — **Proposed**
- **Status:** **Proposed** (2026-08-25, Phase 28 sub-phase **28-03**; final design: `specs/phase-28-feature-revamp/28-03-final-design.md`). **Accept at 28-04** (on build).
