...
## ADR-072 — Global human-readable story identifier (GNS_000001) (Phase 44) — **Proposed**

- **Status:** **Proposed** — DRAFTED 2026-09-25 (Phase 44; genesis-only; adds migration `m0022`). Spec: `specs/phase-44-fixes-bundle.md` (fix 3). Mirror in `bible/04` on Accept.
