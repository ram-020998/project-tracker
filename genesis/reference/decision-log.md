...
## ADR-066 — Run inspection & node observability: capture what the agent was given & produced, per iteration (Phase 39) — **Proposed**
...
## ADR-067 — Grounded artifact verification & cost-aware self-healing: the second reliability tier (Phase 40) — **Proposed**
