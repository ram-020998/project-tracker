...
- **Status:** **Proposed** (2026-08-28, Phase 29; specs `specs/phase-29-ux-design-stage.md` + `phase-29-ux-design-stage/29-01..29-06`). Refines ADR-056 (the first `available:true` stage after Spec). Drafted 29-01, finalized 29-03, Accepted at 29-04/29-06.
