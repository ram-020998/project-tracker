...
## ADR-063 — The Genesis Collaboration Hub: local-first with selective centralization (Phase 35–38) — **Proposed**
- **Status:** **Proposed** (2026-09-05; the Team Collaboration program — specs `specs/phase-35-collaboration-foundations.md` [+ `35-01..35-07`], `specs/phase-36-genesis-hub-appian-app.md`, `specs/phase-37-hub-wireup.md`, `specs/phase-38-collaborative-sdlc.md`). **Amends ADR-026** (local single-user). The concrete Appian backend + contract is **ADR-064**. Mirror in `bible/04` on Accept.
