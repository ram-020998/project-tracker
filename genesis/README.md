...
| 17 | [phase-17](specs/phase-17-business-application-map.md) | Business Application Map (agent-synthesized business flow) | 🛠️ in progress — backend 17-01/02/04 shipped (genesis v0.35.0); 17-03 workflow next |
