...
| 17 | [phase-17](specs/phase-17-business-application-map.md) | Business Application Map (agent-synthesized business flow) | 🛠️ in progress — backend + workflow + web view live (genesis v0.38.0 + genesis-workflows v0.9.0; first live map generated); 17-06 hardening next |
