...
| 19 | [phase-19](specs/phase-19-document-library.md) | Genesis Document Library (attach/parse/sync Drive + uploaded business documents per app; managed-native `gws` connector) | 🚧 IN PROGRESS — 19-01 spike (live-verified) + 19-02 gws connector (code + live smoke test) + 19-03 m0009/DocumentStore done; **code uncommitted** (commit at 19-08). ADR-040/041. Next: 19-04 parsing. See `progress/phase-19-document-library.md` |
