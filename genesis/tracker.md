...
| **Status** | 🟢 Phases 1–5 COMPLETE (M1–M5) — engine, contract+library+lint, distribution, config & secrets, run orchestration & HITL (subprocess worker + 3 HITL modes + FastAPI). 40 platform + 15 core + 2 workflow tests green; CI green. Next: Phase 6 (ERD reference workflow). |
