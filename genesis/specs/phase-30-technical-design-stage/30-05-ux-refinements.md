...
> **Status:** ✅ BUILT LOCALLY (2026-09-03; genesis master, unreleased; frontend-only) — gates green: web tsc + eslint(0) + vitest 224 + build (jest-axe clean); web/static committed. Gate: independent review = SHIP (30-06) ✅ done; RELEASED (30-07). · Part of Phase 30. Repo: **genesis** (web-only). Two small, user-requested fixes folded into this phase.
