...
> **Status:** 🔨 **BUILD IN PROGRESS (2026-09-05)** — data model + record-level security COMPLETE in the dev env; Web-API/expression-rule logic layer + frozen contract + packaging remaining. **ADR-064 Accepted.** As-built: `progress/phase-36-genesis-hub-appian-app.md`. Umbrella + `phase-36-genesis-hub-appian-app/36-01..36-07`. · **Author:** Genesis agent
