...
> §5 (ADRs), §7 (lessons), and §9 (roadmap). **Last refreshed: 2026-08-12 — latest SHIPPED: genesis v0.46.2 +
...
## 2. Current state (as of genesis v0.46.2)
...
genesis/genesis/
  ...
  api/      app.py (create_app FastAPI; version 0.46.2; instantiates ChatManager + ChatRunSupervisor + SkillService; registers chat/copilot/skills + **native-mcp** + **applications** + **documents** + **features** routes + per-session skill-output endpoints).
