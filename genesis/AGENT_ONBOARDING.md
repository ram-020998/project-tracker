...
> §5 (ADRs), §7 (lessons), and §9 (roadmap). **Last refreshed: 2026-08-07 — latest SHIPPED: genesis v0.35.0 +
...
**82** · genesis-appian-parser **13** (vs a real vendored package + a no-SAIL guard) · genesis-workflows **68** (incl. 13 code-review + 16 design-doc + 12 sync-application + 11 generate-business-map) + `ci/validate_skills.py` gate · web **126** Vitest
...
### 🛠️ IN PROGRESS — Phase 17: Business Application Map (backend 17-01/02/04 + 17-03 workflow SHIPPED; 17-05 web NEXT)
...
> gates). NEXT = 17-05 web Business Map view (React Flow A value stream + B capability constellation) → 17-06
> quality/acceptance against the real app.**
