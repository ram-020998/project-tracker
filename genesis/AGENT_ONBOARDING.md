...
> §5 (ADRs), §7 (lessons), and §9 (roadmap). **Last refreshed: 2026-08-12 — latest SHIPPED: genesis v0.47.0 +
...
## 2. Current state (as of genesis v0.47.0)
...
genesis/genesis/
  ...
  api/      app.py (create_app FastAPI; version 0.47.0; instantiates ChatManager + ChatRunSupervisor + SkillService; registers chat/copilot/skills + **native-mcp** + **applications** + **documents** + **features** + **system** routes + per-session skill-output endpoints).
