...
### 🛠️ IN PROGRESS — Phase 17: Business Application Map (backend 17-01/02/04 SHIPPED genesis v0.35.0; 17-03 workflow NEXT)
...
> genesis v0.35.0 (301 pytest green, CI 6523081). NEXT = 17-03 the deterministic `generate-business-map` workflow
> (genesis-workflows, pins genesis v0.35.0) → 17-05 web Business Map view → 17-06 quality/acceptance.**
