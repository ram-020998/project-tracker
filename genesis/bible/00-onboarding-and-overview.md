...
> §5 (ADRs), §7 (lessons), and §9 (roadmap). **Last refreshed: 2026-08-24 — IN PROGRESS: Phase 27 — UI/UX Revamp (light-first Indigo·Slate re-theme + UX overhaul, frontend-only; 27-01..27-07 done, 27-04..27-07 BUILT LOCAL/unreleased, next 27-08, ships v0.53.0 — see §9). Latest SHIPPED: genesis v0.52.1 +
