...
> are **BUILT + tested (genesis pytest 625, web vitest 189, workflows 86, ruff clean) but UNRELEASED** — local on master, no tag
> (the phase release is 26-07). **NEXT = 26-04** (the memory-maintenance "dreaming" workflow). Repos: **genesis** +
