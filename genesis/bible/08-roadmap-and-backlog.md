...
### 🟡 SPECS DRAFTED (NOT STARTED — awaiting user sign-off) — Phase 32: Finalize Stories (Feature Breakdown → first-class, editable Story records)

> **Specs:** `specs/phase-32-finalize-stories.md` (umbrella) + `phase-32-finalize-stories/32-01..32-05`. **ADR-060** (Proposed). **Single-repo (genesis) + one migration (m0016);** genesis-core / kiro-agent-sdk / genesis-workflows / genesis-appian-parser unchanged. **NOT BUILT — specs drafted 2026-09-04; do not implement until the user approves the specs.**
>
