...
### 🟡 SPECS DRAFTED (NOT STARTED — awaiting user sign-off) — Phase 33: The Workbench (a per-application Kanban execution board)

> **Specs:** `specs/phase-33-workbench.md` (umbrella) + `phase-33-workbench/33-01..33-05`. **ADR-061** (Proposed; **amends ADR-049** nav). **Single-repo (genesis) + one migration (m0017) + one new web dep (`@dnd-kit`);** genesis-core / kiro-agent-sdk / genesis-workflows / genesis-appian-parser unchanged. **NOT BUILT — specs drafted 2026-09-04; do not implement until the user approves the specs.**
>
