...
### ⭐ SHIPPED (COMPLETE) — Phase 41: Dev MCP 26.6.90 upgrade (basic auth) + SAIL CLI install — genesis v0.72.2 + genesis-workflows v0.19.0 (2026-09-15, CI green + DEPLOYED)
