...
### 🟡 SPECS DRAFTED (NOT STARTED — awaiting user sign-off) — Phase 34: Design Lane Automation (the Workbench Design + Design Review lanes)

> **Specs:** `specs/phase-34-design-lane-automation.md` (umbrella) + `phase-34-design-lane-automation/34-01..34-07`. **ADR-062** (Proposed; **amends ADR-061** — the per-lane automation begins). **NOT BUILT — specs drafted 2026-09-04; do not implement until the user approves the specs.** **Multi-repo:** genesis (m0018 + backend + web) + genesis-workflows (add `story-design-analysis`; remove `design-doc`); genesis-core / kiro-agent-sdk / genesis-appian-parser unchanged.
>
