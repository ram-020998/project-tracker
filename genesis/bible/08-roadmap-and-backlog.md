...
### 🟡 IN PROGRESS — Team Collaboration: local-first + selective centralization to a shared Appian Hub (Phases 35–38) — **Phase 35 SHIPPED (genesis v0.63.0); Phase 36 COMPLETE (Appian-side); Phase 37 SHIPPED (genesis v0.64.0 — Hub wire-up: AppianHubProvider + KB sharing + identity/teams + sync-UX); Phase 38 drafted**
