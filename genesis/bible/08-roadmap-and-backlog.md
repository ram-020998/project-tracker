...
### 🟡 IN PROGRESS — Team Collaboration: local-first + selective centralization to a shared Appian Hub (Phases 35–38) — **Phase 35 SHIPPED (genesis v0.63.0); Phase 36 COMPLETE (Appian-side — the Genesis Hub app built + contract frozen + live-validated); 37–38 drafted**
