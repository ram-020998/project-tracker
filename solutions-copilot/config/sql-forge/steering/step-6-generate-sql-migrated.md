...
- ⚠️ **USE UPPER_SNAKE COLUMN NAMES** — SQL uses the database column names, not camelCase. Get the mapping from `solutions-intelligence.get_field_map`.
...
```sql
-- ============================================================
-- Solutions Intelligence SQL Forge — Bulk Data SQL
