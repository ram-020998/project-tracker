...
Generate a visual Entity Relationship Diagram from the Atlas KB schema data.
...
```
Atlas MCP: get_app_schema(app_name)
Atlas MCP: get_schema_relationships(app_name)
...
### Single entity focus
```
Atlas MCP: get_app_schema(app_name, table_name="AS_GSS_EVALUATION")
Atlas MCP: get_schema_relationships(app_name, table_name="AS_GSS_EVALUATION")
```
