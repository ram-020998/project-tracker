...
1. `solutions-intelligence.get_app_overview(app)` → total counts and bundle list
...
4. `solutions-intelligence.get_hub_objects(app)` → most-shared components (high impact, high reuse)
