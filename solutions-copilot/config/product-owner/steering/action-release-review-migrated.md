...
1. `solutions-intelligence.list_releases(app)` → show release history with dates and change counts
2. `solutions-intelligence.get_changelog(app, release)` → detailed changes
...
- Use `solutions-intelligence.get_changelog(app, release, filter_bundle="bundle_name")` to see specific changes
