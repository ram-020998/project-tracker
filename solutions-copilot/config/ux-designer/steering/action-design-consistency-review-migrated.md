...
This action uses Solutions Intelligence MCP tools to retrieve existing interfaces from the target app and Aurora Design System docs as the baseline standard.
...
If the user provides an interface name in Solutions Intelligence:
```
...
```
solutions-intelligence.get_object_code(app, "existing_interface_1")
solutions-intelligence.get_object_code(app, "existing_interface_2")
solutions-intelligence.get_object_code(app, "existing_interface_3")
```
