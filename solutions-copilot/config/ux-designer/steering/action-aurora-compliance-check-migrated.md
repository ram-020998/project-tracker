...
- A SAIL mockup or interface code (pasted, file path, or Solutions Intelligence interface name)
...
Ask the user for:
1. **SAIL code** — Pasted code, file path, or interface name in Solutions Intelligence
