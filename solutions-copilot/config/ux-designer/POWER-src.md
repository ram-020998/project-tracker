...
# Appian Atlas — UX Designer Power
...
|---|---|---|
| `GITLAB_TOKEN` | Yes | GitLab token for Atlas knowledge base access |
...
- **Atlas MCP tools** to retrieve existing interfaces, bundles, and dependencies from the knowledge base
...
1. Call `list_applications` to validate knowledge base access
2. Present the action menu

## MCP Tool Reference

### Application & Knowledge Base
- `list_applications` — See available Appian applications
