...
1. Use Jarvis to find the visibility rule: search for `BL_visibility` or `showWhen` + action name
...
The group names vary by app — use Jarvis to search for the relevant constant (e.g., `search_objects_by_name` with "GRP_" prefix).
